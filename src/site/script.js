...
const translations = {
    ...
    'nav.book': 'Varaa aika',
    'hero.eyebrow': 'Hieronta \u00b7 Ulvila | Turku',
    ...
    'faq.q5': 'Myytekö lahjakortteja hierontaan?',
    'faq.a5': 'Kyllä! Lahjakortti on loistava lahja ystävälle, läheiselle tai kollegalle. Voit tilata lahjakortin ottamalla minuun yhteyttä puhelimitse tai WhatsAppissa, ja lähetän sen sinulle sähköpostitse. Lahjakortti on voimassa 6 kuukautta ostopäivästä.',
  ...
  en: {
    ...
    'hero.eyebrow': 'Massage \u00b7 Ulvila | Turku',
    ...
    'faq.q5': 'Do you sell gift cards for massage?',
    'faq.a5': 'Yes! A gift card is a wonderful gift for a friend, family member, or colleague. You can order one by contacting me by phone or WhatsApp, and I will send it to you by email. Gift cards are valid for 6 months from the date of purchase.',
